...
module.exports.PelnyRaportResponse = async (content) => {
    ...
    return {
        ...
        voivodeship: nvl(body.praw_adSiedzWojewodztwo_Nazwa, nvl(body.fiz_adSiedzWojewodztwo_Nazwa, null)),
        ...
        flat_no: nvl(body.praw_adSiedzNumerLokalu, nvl(body.fiz_adSiedzNumerLokalu, null)),
